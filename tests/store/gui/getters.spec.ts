...
vi.mock('@/store/variables', () => ({
    allDashboardPanels: [
        'webcam', 'temperature', 'dro', 'jog', 'cnc-status', 'macros',
        'machine-settings', 'miscellaneous', 'spindle-coolant', 'wcs',
        'offsets', 'offset-preview', 'mdi', 'miniconsole', 'led-effects',
    ],
...
const defaultState = (overrides: Partial<GuiState> = {}): any => ({
    ...
    view: {
        ...
        configfiles: { countPerPage: 10, sortBy: 'filename', sortDesc: false, showHiddenFiles: false, hideBackupFiles: false, currentPath: '', rootPath: 'config', selectedFiles: [] },
        gcodefiles: { countPerPage: 10, search: '', sortBy: 'modified', sortDesc: true, showHiddenFiles: false, showCompletedFiles: true, hideMetadataColumns: [], orderMetadataColumns: [], currentPath: '', selectedFiles: [] },
        history: { countPerPage: 10, toggleChartCol2: 'chart', toggleChartCol3: 'filament_usage', hidePrintStatus: [], hideColums: [], selectedJobs: [], showMaintenanceEntries: true, showPrintJobs: true },
        jobqueue: { countPerPage: 10 },
        lockedSliders: [],
        mmu: { showClogDetection: true, showTtgMap: true, showDetails: true, largeFilamentStatus: false, showLogos: true, showName: true, showUnavailableSpoolColor: false },
        tempchart: { boolTempchart: true, hiddenDataset: [], hideMcuHostSensors: false, hideMonitors: false, autoscale: false, datasetSettings: {} },
        timelapse: { countPerPage: 10, sortBy: 'modified', sortDesc: true, showHiddenFiles: false, currentPath: 'timelapse', selectedFiles: [] },
